...
<cfinvoke component="#service#" method="get_repositories" returnvariable="get_repositories">
	...
	<cfif IsDefined("RepositoryName")>
		<cfinvokeargument name="RepositoryName" value="#RepositoryName#">
	</cfif>
</cfinvoke>
...
<cfif format is "html">
	...
	<cfinclude template="/header.cfm">
		<div class="container">
		<ol>
		<cfoutput query="get_repositories">
			<li>#RepositoryName# #RepositoryURL#</li>
		</cfoutput>
		</ol>
		</div>
...
<cfelseif format is "json">
	...
	<!--- RepositoryName, RepositoryURL RepositoryID, RepositoryUUID
1 --->
	<cfset return_string = '['>
	<cfoutput query="get_repositories">
		<cfset return_string = '#return_string#{"RepositoryName": "#RepositoryName#", "RepositoryURL": "#RepositoryURL#", "RepositoryID": "#RepositoryID#","RepositoryUUID":"#RepositoryUUID#"},'>
	</cfoutput>
